...
class Validators {
  ...
  static String? validatePassword(String? value) {
    ...
    final weakPatterns = [
      ...
      RegExp(r'^(password|12345678|qwerty|abc123|letmein|admin|user)$', caseSensitive: false),
    ];
  ...
  static String? validateUserName(String? value) {
    ...
    if (!RegExp(r'^[a-zA-Z0-9\u3040-\u309F\u30A0-\u30FF\u4E00-\u9FAF\u002D\u005F\u0020]+$').hasMatch(trimmedValue)) {
      return 'ユーザー名に使用できない文字が含まれています';
    }
    
    // 不適切な文字列のチェック
    final inappropriateWords = ['admin', 'root', 'test', 'system', 'null', 'undefined'];
  ...
  static String? validateQRData(String? value) {
    ...
    if (uri != null && uri.scheme == 'animeishi' && uri.pathSegments.length == 2) {
